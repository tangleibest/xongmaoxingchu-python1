...
'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0'}
    ...
    #当前租约
    current_renewal = html1.xpath('/html/body/div[4]/div[1]/div[1]/div[8]/div[2]/div[2]/ul/li[1]/div/p[2]/span[1]/b/text()')
    if current_renewal is  None or len(current_renewal)==0:
        current_renewal=''
    else:
        current_renewal=current_renewal[0]
    #剩余租约
    cash_pledge1 = html1.xpath('/html/body/div[4]/div[1]/div[1]/div[8]/div[2]/div[2]/ul/li[1]/div/p[2]/span[2]/b/text()')
    if cash_pledge1 is  None or len(cash_pledge1)==0:
        cash_pledge1=''
    else:
        cash_pledge1=cash_pledge1[0]
    #最长可租
    cash_pledge2 = html1.xpath('/html/body/div[4]/div[1]/div[1]/div[8]/div[2]/div[2]/ul/li[1]/div/p[2]/span[3]/b/text()')
    if cash_pledge2 is  None or len(cash_pledge2)==0:
        cash_pledge2=''
    else:
        cash_pledge2=cash_pledge2[0]
    #续租方式
    cash_pledge3 = html1.xpath('/html/body/div[4]/div[1]/div[1]/div[8]/div[2]/div[2]/ul/li[1]/div/p[3]/span[1]/b/text()')
    ...
    #分时出租
    cash_pledge4 = html1.xpath('/html/body/div[4]/div[1]/div[1]/div[8]/div[2]/div[2]/ul/li[1]/div/p[3]/span[2]/b/text()')
