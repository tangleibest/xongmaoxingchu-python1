...
for time in time_list:
    ...
    for city in city_list:
        ...
        cur = db.cursor()
        sql = "SELECT a.project_id,a.project_name,b.address,b.latitude,b.longitude from project a LEFT JOIN development.project_base_info b on a.project_id=b.tid WHERE  a.area_name='%s' and a.project_name is not null" % city
        cur.execute(sql)
        results = cur.fetchall()
        print(results)
        db2=pool_mapmarkeronline.connection()

        sql2="select shop_id,client_name,month_sale_num,latitude,longitude,address,average_price,own_set_cate,call_center from t_map_client_mt_%s_mark where   update_count=%s and month_sale_num!=0" %(city_name,update_time)
        ...
        for row in results:
            ...
            if project_name in xm_project_info.keys():
                ...
                for row2 in results2:
                    ...
                    if distance<=3:
                        values=(project_id,own_set_cate,shop_id,client_name,month_sale_num,average_price,'mt',distance,latitude,longitude,address,city,update_time2,call_center)
