...
time_list = [[13, '2020-03-01'], [12, '2020-02-01'], [11, '2020-01-01'], [10, '2019-12-01']]
...
for time in time_list:
    ...
    for city in city_list:
        ...
        cur = db.cursor()
        sql = "SELECT a.project_id,a.project_name,b.address,b.latitude,b.longitude from project a LEFT JOIN development.project_base_info b on a.project_id=b.tid WHERE a.project_id in (1583482473252890,1577157249977472,1583146188805410,1566268131084472) and a.area_name='%s' and a.project_name is not null" % city
        cur.execute(sql)
        results = cur.fetchall()
        print(results)
        db2 = pool_mapmarkeronline.connection()

        sql2 = "select shop_id,client_name,month_sale_num,latitude,longitude,address,own_set_cate,call_center from t_map_client_elm_%s_mark where   update_count=%s and month_sale_num!=0" % (
        ...
        for row in results:
            ...
            if project_name in xm_project_info.keys():
                ...
                for row2 in results2:
                    ...
                    if distance <= 3:
                        values = (
                            project_id, own_set_cate, shop_id, client_name, month_sale_num, average_price, 'elm',
                            distance,
