...
time = [[10, 12, '2020-02-01'], [9, 11, '2020-01-01'], [8, 10, '2019-12-01']]
...
for ti in time:
    for city in city_list:
        ...
        sql = "SELECT a.project_id,a.project_name,b.address,b.latitude,b.longitude from project a LEFT JOIN development.project_base_info b on a.project_id=b.tid WHERE a.project_id in (1583482473252890,1577157249977472,1583146188805410,1566268131084472) and  a.area_name='%s'" % city
        ...
        for row in results:
            ...
            for gr in group_elm_1:
                ...
                cate_dir[gr[0]] = [dict2_value[0], dict2_value[1], dict2_value[2], dict2_value[3], gr[1], gr[2], 0, 0,
                                   0, 0, 0, 0]
            for gr in group_mt_3:
                print(gr[0])
                dict3_value = cate_dir.get(gr[0])

                cate_dir[gr[0]] = [dict3_value[0], dict3_value[1], dict3_value[2], dict3_value[3], dict3_value[4],
                                   dict3_value[5], gr[1], gr[2], 0, 0, 0, 0]
            for gr in group_mt_2:
                dict4_value = cate_dir.get(gr[0])
                cate_dir[gr[0]] = [dict4_value[0], dict4_value[1], dict4_value[2], dict4_value[3], dict4_value[4],
                                   dict4_value[5], dict4_value[6], dict4_value[7], gr[1], gr[2], 0, 0]
            for gr in group_mt_1:
                dict5_value = cate_dir.get(gr[0])
                cate_dir[gr[0]] = [dict5_value[0], dict5_value[1], dict5_value[2], dict5_value[3], dict5_value[4],
                                   dict5_value[5], dict5_value[6], dict5_value[7], dict5_value[8], dict5_value[9],
                                   gr[1], gr[2]]
            # print(cate_dir)
